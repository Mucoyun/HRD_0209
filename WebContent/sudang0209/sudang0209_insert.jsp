	...
	<script>
		function cantry() {
			if(document.iu_form.id.value==""){
				...
				document.iu_form.action = "sudang0209_insert_process.jsp";
...
<body>
	...
	<%
		...
		try{
			String sql = "select name from info0209 where id=?";
	...
	<section>
		<h2>수당 정보 등록</h2>
		<form name="iu_form" method="post" action="sudang0209_insert.jsp">
			<table id="iu_table">
				<tr>
					<th>사원번호</th>
				...
				<tr>
					<td id="btntd" colspan="4">
						...
						<button type="button" onclick="cantry()">저장</button>
					</td>
				</tr>
			</table>
		</form>
